<template>
  <v-flex lg12 md12 sm12 xs12 v-resize="onResize">
    ...
    <v-flex :style="toolbarTab" class="scroll-y">
      <nuxt-child />
    </v-flex>
  </v-flex>
</template>
  ...
  export default {
    ...
    data: () => ({
      ...
      titles: [
        {
          title: 'Tab1',
          route: '/supplier/becomeasupplier'
        },
        {
          title: 'Tab2',
          route: '/supplier/becomeasupplier/quickregistration'
        },
        {
          title: 'Tab3',
          route: '/supplier/becomeasupplier/information'
        },
      ],
    }),
    methods: {
