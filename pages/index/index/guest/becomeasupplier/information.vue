  ...
  export default {
    ...
    data: () => ({
      ...
      daysChoices: [
        ...
        {title: 'Police Checks', model: false},
        {title: 'Public Liability Insured', model: false},
        {title: 'Equipped', model: false},
        {title: 'Eco Friendly', model: false},
        {title: 'Cert 1 Cleaning', model: false},
        {title: 'Cert 2 Cleaning', model: false},
        {title: 'Cert 3 Cleaning', model: false},
